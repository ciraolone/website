---
layout: base.njk
title: "Masterclass: Crea contenuti come un trattore!"
description: Per creare tanti contenuti, di qualità e in poco tempo, non devi per forza essere un content creator professionista. Questa masterclass fa per te se vuoi mettere il turbo alla tua produzione di contenuti!
hero:
...
- Le fasi della creazione contenuti
- Generare e raccogliere le idee per i contenuti
- Il calendario editoriale infinito
- Dall'idea allo scheletro del contenuto
- Realizzare contenuti video e audio
- Realizzare contenuti testo e immagini
- Approccio multicanale e multiformato
- Programmare i contenuti al meglio
- Riutilizzare i contenuti e ridargli vita
...
{{ accordion(
  items=[
    {
      title: "Per chi è adatta questa masterclass?",
      content: "Questa è una masterclass che copre il tema della creazione di contenuti dalla A alla Z. È adatta sia a chi ha esperienza che a chi inizia da zero e vuole saperne di più."
    },
    {
      title: "A chi è pensata la Masterclass?",
      content: "La Masterclass è pensata per:<br><br>- Professionisti che vogliono iniziare a creare contenuti<br>- Piccole aziende che hanno difficoltà ad essere costanti con la creazione contenuti<br>- Agenzie che vogliono avere una strategia chiara e un metodo agile<br>- Persone che sognano di diventare content creator ma non sanno da dove partire<br>- Chi già pubblica contenuti, ma vogliono fare il salto di qualità<br>- Chi rimanda da sempre perché non ha tempo o non ha il coraggio di iniziare"
    },
    {
