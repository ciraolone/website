---
layout: base.njk
title: "Masterclass: Lavora come un drago"
...
- Come definire la roadmap
- Calcolare i prezzi e definire il proprio valore
- Dove trovare i clienti giusti
- Preventivi e proposte di collaborazione
- Le basi del contratto per tutelare tutti
- Gestire il tempo e le priorità
- Gestire i progetti e le scadenze
- Comunicare meglio con i clienti
- 6 consigli per spaccare
- Domande & Risposte
...
- Fai fatica a trovare clienti e hai la tentazione di svendere il tuo lavoro
- Avverti un forte sconforto e senso di solitudine
- Non riesci a concentrarti e portare a termine i progetti più significativi
- Perdi un sacco di tempo per capire cosa fare invece di… fare
- Vivi con l'ansia di non avere abbastanza lavoro e dici di sì anche a progetti che non risuonano con te
- Il sogno che avevi si sta trasformando in un incubo
- Hai provato a collaborare con altri professionisti, ma è andata sempre male
...
{{ accordion(
  items=[
    {
      title: "Devo già essere un freelance?",
      content: "Certo che no! La masterclass è indicata per chi vuole cominciare con il piede giusto oppure per chi vuole potenziare un'attività già esistente."
    },
    {
      title: "A chi è pensata la Masterclass?",
      content: "La Masterclass è pensata per:<br><br>- Lavoratori dipendenti che vogliono mettersi in proprio<br>- Freelance che vogliono ottimizzare le proprie attività e ottenere più risultati<br>- Persone in cerca di nuove opportunità lavorative<br>- Studenti che si affacciano sul mondo del lavoro"
    },
    {
